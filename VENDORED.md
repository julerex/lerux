...
| userspace runtime | `userspace/runtime/` | [relibc/redox-rt + generic-rt](https://gitlab.redox-os.org/redox-os/relibc) | `TBD` (forked from `tryredox/relibc` 2026-05-30) | MIT | 2026-05-31 | Lerux-owned `no_std` runtime; bootstrap + initfs daemons (`lerux-entry`, `lerux-shim`) |
