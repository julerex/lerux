...
| relibc (partial) | `vendor/relibc/` | [redox-os/relibc](https://gitlab.redox-os.org/redox-os/relibc) | `TBD` (copied from `tryredox/relibc` 2026-05-30) | MIT / BSD | 2026-05-30 | Snapshot for init/daemon static link via `.toolchain/`; `dlmalloc-rs` from `tryredox/dlmalloc-rs`; runtime crates moved to `userspace/runtime/` |
