...
| **HW x86** | Gigabyte Z97-D3H (this desktop) | `pc_z97_d3h` hello + COM1; native e1000e/AHCI not yet | Optional `test-hw` |

## Arch drivers

| Role | aarch64 virt | RISC-V virt | x86_64 q35 | Z97-D3H metal |
|------|--------------|-------------|------------|----------------|
| Serial | PL011 + serial-virt | NS16550 MMIO + serial-virt | COM1 ioport + serial-virt | COM1 ioport (`pc_z97_d3h`) |
...
just deploy-pc DEST=/path/to/usb-fat   # Z97-D3H hello image (Multiboot 2)
