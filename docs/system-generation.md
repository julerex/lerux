...
36 templates under `userspace/systems/templates/`. Most still embed hand channels for smoke boards that have **no** profile. Profile-owned boards splice channels on every `render_system`.
