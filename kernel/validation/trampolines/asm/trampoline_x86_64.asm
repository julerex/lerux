; SMP AP bring-up trampoline for x86_64.
; Source of truth for kernel/src/arch/x86_shared/trampoline.rs (x86_64 array).
; Assembled with: nasm -f bin -o trampoline_x86_64.bin trampoline_x86_64.asm
; Captured from redox-os/kernel src/asm/x86_64/trampoline.asm at vendoring time.
