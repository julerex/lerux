...
impl IretRegisters {
    pub fn dump(&self) {
        ...
        unsafe {
            let fsbase = crate::x86::msr::rdmsr(crate::x86::msr::IA32_FS_BASE);
            let gsbase = crate::x86::msr::rdmsr(crate::x86::msr::IA32_KERNEL_GSBASE);
            let kgsbase = crate::x86::msr::rdmsr(crate::x86::msr::IA32_GS_BASE);
            println!(
                "FSBASE  {:016x}\nGSBASE  {:016x}\nKGSBASE {:016x}",
...
impl InterruptStack {
    pub fn init(&mut self) {
        ...
        self.iret.rflags = crate::x86::bits64::rflags::RFlags::FLAGS_IF.bits() as usize;
    ...
    ($name:ident, $save1:ident!, $save2:ident!, $rstor2:ident!, $rstor1:ident!, is_paranoid: $is_paranoid:expr_2021, |$stack:ident| $code:block) => {
        ...
        pub unsafe extern "C" fn $name() {
            ...
            core::arch::naked_asm!(
                ...
                inner = sym inner,
                IA32_GS_BASE = const(crate::x86::msr::IA32_GS_BASE),
