...
2:
    ...
    ss_sel = const(SegmentSelector::new(gdt::GDT_USER_DATA as u16, crate::x86::Ring::Ring3).bits()),
    cs_sel = const(SegmentSelector::new(gdt::GDT_USER_CODE as u16, crate::x86::Ring::Ring3).bits()),
    );
}
unsafe extern "C" {
    // TODO: macro?
