...
#[cfg(target_arch = "x86")]
use crate::x86::bits32::task::TaskStateSegment;
...
pub unsafe fn install_pcr(pcr_ptr: *mut ProcessorControlRegion) {
    ...
    unsafe {
        ...
        crate::x86::msr::wrmsr(crate::x86::msr::IA32_GS_BASE, pcr as *mut _ as usize as u64);
        ...
        crate::x86::msr::wrmsr(crate::x86::msr::IA32_KERNEL_GSBASE, 0);

        // Set the userspace FSBASE to zero.
        crate::x86::msr::wrmsr(crate::x86::msr::IA32_FS_BASE, 0);
    }
