...
; Assembled by build.rs: nasm -f bin -o $OUT_DIR/trampoline trampoline.asm
; Included in arch/x86_shared/trampoline.rs via include_bytes!(concat!(env!("OUT_DIR"), "/trampoline"))
