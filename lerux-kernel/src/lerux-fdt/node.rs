...
impl core::fmt::Display for FdtNode<'_, '_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        crate::fdt::pretty_print::print_node(f, *self, 0)?;
        Ok(())
    }
}
...
impl<'b, 'a: 'b> FdtNode<'b, 'a> {
    ...
    pub fn reg(self) -> Option<impl Iterator<Item = crate::fdt::MemoryRegion> + 'a> {
    ...
    pub fn ranges(self) -> Option<impl Iterator<Item = crate::fdt::MemoryRange> + 'a> {
