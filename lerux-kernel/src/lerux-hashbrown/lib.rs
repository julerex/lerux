...
pub mod raw {
    ...
    pub mod rayon {
        pub use crate::hashbrown::external_trait_impls::rayon::raw::*;
    }
}
#[cfg(not(feature = "raw"))]
mod raw;
...
pub mod hash_map {
    ...
    pub use crate::hashbrown::map::*;

    #[cfg(feature = "rustc-internal-api")]
    pub use crate::hashbrown::rustc_entry::*;
    ...
    /// [rayon]: https://docs.rs/rayon/1.0/rayon
    pub mod rayon {
        pub use crate::hashbrown::external_trait_impls::rayon::map::*;
    }
}
pub mod hash_set {
    //! A hash set implemented as a `HashMap` where the value is `()`.
    pub use crate::hashbrown::set::*;
    ...
    /// [rayon]: https://docs.rs/rayon/1.0/rayon
    pub mod rayon {
        pub use crate::hashbrown::external_trait_impls::rayon::set::*;
    }
}
pub mod hash_table {
    //! A hash table implemented with quadratic probing and SIMD lookup.
    pub use crate::hashbrown::table::*;
    ...
    /// [rayon]: https://docs.rs/rayon/1.0/rayon
    pub mod rayon {
        pub use crate::hashbrown::external_trait_impls::rayon::table::*;
    }
}
