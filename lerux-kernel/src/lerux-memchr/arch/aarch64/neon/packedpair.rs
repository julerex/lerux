...
use crate::memchr::arch::{all::packedpair::Pair, generic::packedpair};
...
mod tests {
    ...
    fn forward_substring() {
        crate::memchr::tests::substring::Runner::new().fwd(find).run()
    }
    ...
    fn forward_packedpair() {
        ...
        crate::memchr::tests::packedpair::Runner::new().fwd(find).run()
    }
