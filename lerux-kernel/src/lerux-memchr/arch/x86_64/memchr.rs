...
macro_rules! unsafe_ifunc {
    (
        ...
        unsafe fn find_avx2(
            ...
            use crate::memchr::arch::x86_64::avx2::memchr::$memchrty;
        ...
        unsafe fn find_sse2(
            ...
            use crate::memchr::arch::x86_64::sse2::memchr::$memchrty;
            $memchrty::new_unchecked($($needle),+)
                .$memchrfind($hay_start, $hay_end)
        }
        ...
        unsafe fn find_fallback(
            ...
            use crate::memchr::arch::all::memchr::$memchrty;
        ...
        unsafe fn detect(
            ...
            let fun = {
                ...
                #[cfg(target_feature = "sse2")]
                {
                    use crate::memchr::arch::x86_64::{sse2, avx2};
