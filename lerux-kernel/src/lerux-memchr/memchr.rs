...
use crate::memchr::arch::generic::memchr as generic;
...
pub struct Memchr<'h> {
    needle1: u8,
    it: crate::memchr::arch::generic::memchr::Iter<'h>,
}
...
impl<'h> Memchr<'h> {
    ...
    pub fn new(needle1: u8, haystack: &'h [u8]) -> Memchr<'h> {
        Memchr {
            needle1,
            it: crate::memchr::arch::generic::memchr::Iter::new(haystack),
        }
    }
}
...
unsafe fn memchr_raw(
    ...
    #[cfg(target_arch = "x86_64")]
    {
        ...
        crate::memchr::arch::x86_64::memchr::memchr_raw(needle, start, end)
    }
    #[cfg(all(target_arch = "wasm32", target_feature = "simd128"))]
    {
        crate::memchr::arch::wasm32::memchr::memchr_raw(needle, start, end)
    }
    #[cfg(target_arch = "aarch64")]
    {
        crate::memchr::arch::aarch64::memchr::memchr_raw(needle, start, end)
    }
    #[cfg(not(any(
        target_arch = "x86_64",
    ...
    {
        crate::memchr::arch::all::memchr::One::new(needle).find_raw(start, end)
    }
}
...
unsafe fn memrchr_raw(
    ...
    #[cfg(target_arch = "x86_64")]
    {
        crate::memchr::arch::x86_64::memchr::memrchr_raw(needle, start, end)
    }
    #[cfg(all(target_arch = "wasm32", target_feature = "simd128"))]
    {
        crate::memchr::arch::wasm32::memchr::memrchr_raw(needle, start, end)
    }
    #[cfg(target_arch = "aarch64")]
    {
        crate::memchr::arch::aarch64::memchr::memrchr_raw(needle, start, end)
    }
    #[cfg(not(any(
        target_arch = "x86_64",
        all(target_arch = "wasm32", target_feature = "simd128"),
    ...
    {
        crate::memchr::arch::all::memchr::One::new(needle).rfind_raw(start, end)
    }
}
...
unsafe fn memchr2_raw(
    ...
    #[cfg(target_arch = "x86_64")]
    {
        crate::memchr::arch::x86_64::memchr::memchr2_raw(needle1, needle2, start, end)
    }
    #[cfg(all(target_arch = "wasm32", target_feature = "simd128"))]
    {
        crate::memchr::arch::wasm32::memchr::memchr2_raw(needle1, needle2, start, end)
    }
    #[cfg(target_arch = "aarch64")]
    {
        crate::memchr::arch::aarch64::memchr::memchr2_raw(needle1, needle2, start, end)
    }
    #[cfg(not(any(
        target_arch = "x86_64",
        all(target_arch = "wasm32", target_feature = "simd128"),
    ...
    {
        crate::memchr::arch::all::memchr::Two::new(needle1, needle2)
            .find_raw(start, end)
    }
}
...
unsafe fn memrchr2_raw(
    ...
    #[cfg(target_arch = "x86_64")]
    {
        crate::memchr::arch::x86_64::memchr::memrchr2_raw(needle1, needle2, start, end)
    }
    #[cfg(all(target_arch = "wasm32", target_feature = "simd128"))]
    {
        crate::memchr::arch::wasm32::memchr::memrchr2_raw(needle1, needle2, start, end)
    }
    #[cfg(target_arch = "aarch64")]
    {
        crate::memchr::arch::aarch64::memchr::memrchr2_raw(
...
unsafe fn memchr3_raw(
    ...
    #[cfg(target_arch = "x86_64")]
    {
        crate::memchr::arch::x86_64::memchr::memchr3_raw(
            needle1, needle2, needle3, start, end,
        )
    }
    #[cfg(all(target_arch = "wasm32", target_feature = "simd128"))]
    {
        crate::memchr::arch::wasm32::memchr::memchr3_raw(
            needle1, needle2, needle3, start, end,
        )
    }
    #[cfg(target_arch = "aarch64")]
    {
        crate::memchr::arch::aarch64::memchr::memchr3_raw(
            needle1, needle2, needle3, start, end,
        )
    }
    #[cfg(not(any(
    ...
    {
        crate::memchr::arch::all::memchr::Three::new(needle1, needle2, needle3)
            .find_raw(start, end)
    }
}
...
unsafe fn memrchr3_raw(
    ...
    #[cfg(target_arch = "x86_64")]
    {
        crate::memchr::arch::x86_64::memchr::memrchr3_raw(
            needle1, needle2, needle3, start, end,
        )
    }
    #[cfg(all(target_arch = "wasm32", target_feature = "simd128"))]
    {
        crate::memchr::arch::wasm32::memchr::memrchr3_raw(
            needle1, needle2, needle3, start, end,
        )
    }
    #[cfg(target_arch = "aarch64")]
    {
        crate::memchr::arch::aarch64::memchr::memrchr3_raw(
            needle1, needle2, needle3, start, end,
        )
    }
    #[cfg(not(any(
...
unsafe fn count_raw(needle: u8, start: *const u8, end: *const u8) -> usize {
    #[cfg(target_arch = "x86_64")]
    {
        crate::memchr::arch::x86_64::memchr::count_raw(needle, start, end)
    }
    #[cfg(all(target_arch = "wasm32", target_feature = "simd128"))]
    {
        crate::memchr::arch::wasm32::memchr::count_raw(needle, start, end)
    }
    #[cfg(target_arch = "aarch64")]
    {
        crate::memchr::arch::aarch64::memchr::count_raw(needle, start, end)
    }
    #[cfg(not(any(
        target_arch = "x86_64",
        all(target_arch = "wasm32", target_feature = "simd128"),
    ...
    {
        crate::memchr::arch::all::memchr::One::new(needle).count_raw(start, end)
    }
}
...
mod tests {
    ...
    #[test]
    fn forward1_iter() {
        crate::memchr::tests::memchr::Runner::new(1).forward_iter(
            |haystack, needles| {
    ...
    #[test]
    fn forward1_oneshot() {
        crate::memchr::tests::memchr::Runner::new(1).forward_oneshot(
    ...
    #[test]
    fn reverse1_iter() {
        crate::memchr::tests::memchr::Runner::new(1).reverse_iter(
            |haystack, needles| {
    ...
    #[test]
    fn reverse1_oneshot() {
        crate::memchr::tests::memchr::Runner::new(1).reverse_oneshot(
    ...
    #[test]
    fn count1_iter() {
        crate::memchr::tests::memchr::Runner::new(1).count_iter(|haystack, needles| {
    ...
    #[test]
    fn forward2_iter() {
        crate::memchr::tests::memchr::Runner::new(2).forward_iter(
            |haystack, needles| {
    ...
    #[test]
    fn forward2_oneshot() {
        crate::memchr::tests::memchr::Runner::new(2).forward_oneshot(
            |haystack, needles| {
                let n1 = needles.get(0).copied()?;
                let n2 = needles.get(1).copied()?;
    ...
    #[test]
    fn reverse2_iter() {
        crate::memchr::tests::memchr::Runner::new(2).reverse_iter(
            |haystack, needles| {
                let n1 = needles.get(0).copied()?;
                let n2 = needles.get(1).copied()?;
    ...
    #[test]
    fn reverse2_oneshot() {
        crate::memchr::tests::memchr::Runner::new(2).reverse_oneshot(
            |haystack, needles| {
                let n1 = needles.get(0).copied()?;
                let n2 = needles.get(1).copied()?;
    ...
    #[test]
    fn forward3_iter() {
        crate::memchr::tests::memchr::Runner::new(3).forward_iter(
            |haystack, needles| {
                let n1 = needles.get(0).copied()?;
                let n2 = needles.get(1).copied()?;
    ...
    #[test]
    fn forward3_oneshot() {
        crate::memchr::tests::memchr::Runner::new(3).forward_oneshot(
            |haystack, needles| {
                let n1 = needles.get(0).copied()?;
                let n2 = needles.get(1).copied()?;
                let n3 = needles.get(2).copied()?;
    ...
    #[test]
    fn reverse3_iter() {
        crate::memchr::tests::memchr::Runner::new(3).reverse_iter(
            |haystack, needles| {
                let n1 = needles.get(0).copied()?;
                let n2 = needles.get(1).copied()?;
                let n3 = needles.get(2).copied()?;
    ...
    #[test]
    fn reverse3_oneshot() {
        crate::memchr::tests::memchr::Runner::new(3).reverse_oneshot(
            |haystack, needles| {
                let n1 = needles.get(0).copied()?;
                let n2 = needles.get(1).copied()?;
                let n3 = needles.get(2).copied()?;
