...
pub use crate::memchr::memmem::searcher::PrefilterConfig as Prefilter;

// This is exported here for use in the crate::memchr::arch::all::twoway
...
pub(crate) use crate::memchr::memmem::searcher::Pre;
...
mod tests {
    ...
    #[test]
    fn forward() {
        crate::memchr::tests::substring::Runner::new()
