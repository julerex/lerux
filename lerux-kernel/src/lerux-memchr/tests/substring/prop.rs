...
use crate::memchr::tests::substring::naive;
    ...
    ($fwd:expr) => {
        ...
        quickcheck::quickcheck! {
            fn qc_fwd_prefix_is_substring(bs: alloc::vec::Vec<u8>) -> bool {
                crate::memchr::tests::substring::prop::prefix_is_substring(&bs, $fwd)
            }

            fn qc_fwd_suffix_is_substring(bs: alloc::vec::Vec<u8>) -> bool {
                crate::memchr::tests::substring::prop::suffix_is_substring(&bs, $fwd)
            }
            ...
            fn qc_fwd_matches_naive(
                ...
                crate::memchr::tests::substring::prop::same_as_naive(
                    false,
                    &haystack,
                    &needle,
                    $fwd,
    ...
    ($rev:expr) => {
        ...
        quickcheck::quickcheck! {
            fn qc_rev_prefix_is_substring(bs: alloc::vec::Vec<u8>) -> bool {
                crate::memchr::tests::substring::prop::prefix_is_substring(&bs, $rev)
            }

            fn qc_rev_suffix_is_substring(bs: alloc::vec::Vec<u8>) -> bool {
                crate::memchr::tests::substring::prop::suffix_is_substring(&bs, $rev)
            }
