...
#[cfg(feature = "coff")]
use crate::object::read::coff;
#[cfg(feature = "elf")]
use crate::object::read::elf;
#[cfg(feature = "macho")]
use crate::object::read::macho;
#[cfg(feature = "pe")]
use crate::object::read::pe;
#[cfg(feature = "wasm")]
use crate::object::read::wasm;
#[cfg(feature = "xcoff")]
use crate::object::read::xcoff;
...
impl<'data, R: ReadRef<'data>> File<'data, R> {
    ...
    #[cfg(feature = "macho")]
    pub fn parse_dyld_cache_image<'cache, E: crate::object::Endian>(
