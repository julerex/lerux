...
/// [`ImageNtHeaders::symbols`](crate::object::read::pe::ImageNtHeaders::symbols).
#[derive(Debug)]
...
/// or [`PeFile`](crate::object::read::pe::PeFile).
...
/// A symbol in a [`CoffFile`](super::CoffFile) or [`PeFile`](crate::object::read::pe::PeFile).
///
/// Most functionality is provided by the [`ObjectSymbol`] trait implementation.
#[derive(Debug, Clone, Copy)]
