...
pub trait Object<'data>: read::private::Sealed {
    ...
    ///
    /// For ELF, this is program headers with type [`PT_LOAD`](crate::object::elf::PT_LOAD).
    /// For Mach-O, this is load commands with type [`LC_SEGMENT`](crate::object::macho::LC_SEGMENT)
    /// or [`LC_SEGMENT_64`](crate::object::macho::LC_SEGMENT_64).
    ...
    /// The UUID from a Mach-O [`LC_UUID`](crate::object::macho::LC_UUID) load command.
    #[inline]
    fn mach_uuid(&self) -> Result<Option<[u8; 16]>> {
        Ok(None)
    }

    /// The build ID from an ELF [`NT_GNU_BUILD_ID`](crate::object::elf::NT_GNU_BUILD_ID) note.
    #[inline]
