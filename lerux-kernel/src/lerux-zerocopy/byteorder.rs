...
[`new`]: crate::zerocopy::byteorder::", stringify!($name), "::new
[`get`]: crate::zerocopy::byteorder::", stringify!($name), "::get
[`set`]: crate::zerocopy::byteorder::", stringify!($name), "::set
[`FromBytes`]: crate::zerocopy::FromBytes
[`IntoBytes`]: crate::zerocopy::IntoBytes
[`Unaligned`]: crate::zerocopy::Unaligned"),
...
macro_rules! module {
    ...
    (@ty $ty:ident, $trait:ident, $desc_str:expr, $endianness_str:expr) => {
        ...
        #[doc = $endianness_str]
        /// byte order.
        pub type $ty = crate::zerocopy::byteorder::$ty<$trait>;
    };
}
