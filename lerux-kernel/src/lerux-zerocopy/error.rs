...
use crate::zerocopy::{util::SendSyncPhantomData, KnownLayout, TryFromBytes, Unaligned};
#[cfg(doc)]
use crate::zerocopy::{FromBytes, Ref};
    ...
    for ConvertError<Infallible, S, V>
{
    ...
    ///
    /// [`Dst: Unaligned`]: crate::zerocopy::Unaligned
    ///
    /// # Examples
    ///
    /// ```
...
impl<Src, Dst: ?Sized> AlignmentError<Src, Dst> {
        ...
        Dst: KnownLayout,
    {
        ...
        let addr_align = 2usize.pow((crate::zerocopy::util::AsAddress::addr(addr)).trailing_zeros());
...
impl<Src, Dst: ?Sized> SizeError<Src, Dst> {
        ...
        Dst: KnownLayout,
    {
        ...
        if let crate::zerocopy::SizeInfo::Sized { size } = Dst::LAYOUT.size_info {
            f.write_str("\nDestination size: ")?;
            size.fmt(f)?;
            f.write_str(" byte")?;
            if size != 1 {
...
unsafe impl<Src, NewSrc, Dst> crate::zerocopy::pointer::TryWithError<NewSrc>
    for crate::zerocopy::ValidityError<Src, Dst>
where
    Dst: TryFromBytes + ?Sized,
{
    type Inner = Src;
    type Mapped = crate::zerocopy::ValidityError<NewSrc, Dst>;
...
// to `f`.
unsafe impl<Src, NewSrc, Dst> crate::zerocopy::pointer::TryWithError<NewSrc> for crate::zerocopy::CastError<Src, Dst>
where
    Dst: ?Sized,
{
    type Inner = Src;
    type Mapped = crate::zerocopy::CastError<NewSrc, Dst>;
...
mod tests {
    ...
    fn alignment_display() {
        ...
        let addr = crate::zerocopy::util::AsAddress::addr(bytes);
        assert_eq!(
