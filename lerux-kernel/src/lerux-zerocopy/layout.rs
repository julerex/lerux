...
mod cast_from {
    ...
    unsafe impl<Src, Dst> crate::zerocopy::pointer::cast::Cast<Src, Dst> for CastFrom<Dst>
    where
    ...
    unsafe impl<Src, Dst> crate::zerocopy::pointer::cast::CastExact<Src, Dst> for CastFrom<Dst>
    where
        Src: KnownLayout + ?Sized,
        Dst: KnownLayout + ?Sized,
    {
    ...
    // operations.
    unsafe impl<Src, Dst> crate::zerocopy::pointer::cast::Project<Src, Dst> for CastFrom<Dst>
    where
        Src: KnownLayout + ?Sized,
        Dst: KnownLayout + ?Sized,
    {
        ...
        fn project(src: PtrInner<'_, Src>) -> *mut Dst {
            ...
            impl<Src: KnownLayout + ?Sized, Dst: KnownLayout + ?Sized> CastParams<Src, Dst> {
                ...
                unsafe fn cast_metadata(
                    ...
                    #[allow(unused)]
                    use crate::zerocopy::util::polyfills::*;
...
mod proofs {
    ...
    fn prove_dst_layout_extend() {
        use crate::zerocopy::util::{max, min, padding_needed_for};
    ...
    fn prove_dst_layout_pad_to_align() {
        use crate::zerocopy::util::padding_needed_for;
