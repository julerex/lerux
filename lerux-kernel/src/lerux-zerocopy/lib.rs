...
#[doc(hidden)]
pub use crate::zerocopy::pointer::invariant::{self, BecauseExclusive};
#[doc(hidden)]
pub use crate::zerocopy::pointer::PtrInner;
...
// Used by `KnownLayout`.
#[doc(hidden)]
pub use crate::zerocopy::layout::*;
// Used by `TryFromBytes::is_bit_valid`.
#[doc(hidden)]
pub use crate::zerocopy::pointer::{invariant::BecauseImmutable, Maybe, Ptr};
...
use crate::zerocopy::util::polyfills::{self, NonNullExt as _, NumExt as _};
    ...
    T: ?Sized + KnownLayout<PointerMetadata = usize>,
{
        ...
        T: KnownLayout<PointerMetadata = usize>,
    {
        const SIZE_INFO: TrailingSliceLayout = match T::LAYOUT.size_info {
            crate::zerocopy::SizeInfo::Sized { .. } => const_panic!("unreachable"),
            crate::zerocopy::SizeInfo::SliceDst(info) => info,
        };
    }
            ...
            I: invariant::Invariants,
        {
            const IS_INFALLIBLE: bool = {
                let is_infallible = match VARIANT_ID {
                    ...
                    // the referent.
                    crate::zerocopy::STRUCT_VARIANT_ID | crate::zerocopy::UNION_VARIANT_ID => true,
                    _enum_variant => {
                        use crate::zerocopy::invariant::{Validity, ValidityKind};
...
pub unsafe trait TryFromBytes {
    ...
    ///
    /// [valid-size]: crate::zerocopy::KnownLayout#what-is-a-valid-size
...
unsafe fn try_read_from<S, T: TryFromBytes>(
    ...
    let mut c_ptr = c_ptr.cast::<_, crate::zerocopy::pointer::cast::CastSized, _>();
...
pub unsafe trait FromZeros: TryFromBytes {
        ...
        Self: KnownLayout<PointerMetadata = usize>,
    {
        ...
        unsafe { crate::zerocopy::util::new_box(count, alloc::alloc::alloc_zeroed) }
    }
...
mod tests {
    ...
    use super::*;
    use crate::zerocopy::util::testutil::*;
    ...
    fn test_try_ref_from_prefix_suffix() {
        use crate::zerocopy::util::testutil::Align;
    ...
    fn test_raw_dangling() {
        use crate::zerocopy::util::AsAddress;
