...
macro_rules! transmute {
    ...
    (#![allow(shrink)] $e:expr) => {{
        ...
        if false {
            ...
            where
                Src: $crate::zerocopy::IntoBytes,
                Dst: $crate::zerocopy::FromBytes,
            {
                let _ = src;
                loop {}
            }
            ...
            use $crate::zerocopy::util::macro_util::core_reexport::mem::ManuallyDrop;
            ...
            let u: Transmute<_, _> = unsafe {
                ...
                $crate::zerocopy::util::macro_util::core_reexport::mem::transmute(e)
            };
            ...
            if false {
                ...
                $crate::zerocopy::util::macro_util::must_use(ManuallyDrop::into_inner(dst))
            }
        }
    }};
    ($e:expr) => {{
        ...
        if false {
            ...
            $crate::zerocopy::util::macro_util::must_use(u)
        }
    }};
}
...
macro_rules! transmute_ref {
    ($e:expr) => {{
        ...
        if false {
            ...
            struct AssertSrcIsIntoBytes<'a, T: ?::core::marker::Sized + $crate::zerocopy::IntoBytes>(&'a T);
            struct AssertSrcIsImmutable<'a, T: ?::core::marker::Sized + $crate::zerocopy::Immutable>(&'a T);
            struct AssertDstIsFromBytes<'a, U: ?::core::marker::Sized + $crate::zerocopy::FromBytes>(&'a U);
            struct AssertDstIsImmutable<'a, T: ?::core::marker::Sized + $crate::zerocopy::Immutable>(&'a T);
            ...
            use $crate::zerocopy::util::macro_util::TransmuteRefDst;
            let t = $crate::zerocopy::util::macro_util::Wrap::new(e);
...
macro_rules! transmute_mut {
    ($e:expr) => {{
        ...
        #[allow(unused)]
        use $crate::zerocopy::util::macro_util::TransmuteMutDst as _;
        let t = $crate::zerocopy::util::macro_util::Wrap::new(e);
        if false {
...
macro_rules! try_transmute {
    ($e:expr) => {{
        ...
        if false {
            ...
            $crate::zerocopy::util::macro_util::try_transmute::<_, _>(e)
        }
    }}
}
...
/// be explicitly specified in the macro invocation.
///
/// [`TryFromBytes`]: crate::zerocopy::TryFromBytes
///
/// # Size compatibility
///
...
macro_rules! try_transmute_ref {
    ($e:expr) => {{
        ...
        use $crate::zerocopy::util::macro_util::TryTransmuteRefDst as _;
        let t = $crate::zerocopy::util::macro_util::Wrap::new(e);
        if false {
            // This branch exists solely to force the compiler to infer the type
            // of `Dst` *before* it attempts to resolve the method call to
...
macro_rules! try_transmute_mut {
    ($e:expr) => {{
        ...
        #[allow(unused_imports)]
        use $crate::zerocopy::util::macro_util::TryTransmuteMutDst as _;
        let t = $crate::zerocopy::util::macro_util::Wrap::new(e);
        if false {
            // This branch exists solely to force the compiler to infer the type
            // of `Dst` *before* it attempts to resolve the method call to
...
///
/// [`FromBytes`]: crate::zerocopy::FromBytes
/// [`byteorder`]: crate::zerocopy::byteorder
///
/// # Examples
///
...
macro_rules! include_value {
    ($file:expr $(,)?) => {
        $crate::zerocopy::transmute!(*::core::include_bytes!($file))
    };
}
...
macro_rules! cryptocorrosion_derive_traits {
    (
        ...
        $crate::zerocopy::cryptocorrosion_derive_traits!(@assert_allowed_struct_repr #[repr($repr)]);
        ...
        // SAFETY: See inline.
        unsafe impl $(<$($tyvar),*>)? $crate::zerocopy::TryFromBytes for $name$(<$($tyvar),*>)?
        where
            $(
                $($tuple_field_ty: $crate::zerocopy::FromBytes,)*
            )?

            $(
                $($field_ty: $crate::zerocopy::FromBytes,)*
            )?
        {
            #[inline(always)]
            fn is_bit_valid<A>(_: $crate::zerocopy::Maybe<'_, Self, A>) -> bool
            where
                A: $crate::zerocopy::invariant::Alignment,
            {
        ...
        unsafe impl $(<$($tyvar),*>)? $crate::zerocopy::FromZeros for $name$(<$($tyvar),*>)?
        where
            $(
                $($tuple_field_ty: $crate::zerocopy::FromBytes,)*
            )?
        ...
        unsafe impl $(<$($tyvar),*>)? $crate::zerocopy::FromBytes for $name$(<$($tyvar),*>)?
        where
            $(
                $($tuple_field_ty: $crate::zerocopy::FromBytes,)*
            )?
        ...
        unsafe impl $(<$($tyvar),*>)? $crate::zerocopy::IntoBytes for $name$(<$($tyvar),*>)?
        where
            $(
                $($tuple_field_ty: $crate::zerocopy::IntoBytes,)*
            )?

            $(
                $($field_ty: $crate::zerocopy::IntoBytes,)*
            )?

            (): $crate::zerocopy::util::macro_util::PaddingFree<
                Self,
                {
                    $crate::zerocopy::cryptocorrosion_derive_traits!(
        ...
        unsafe impl $(<$($tyvar),*>)? $crate::zerocopy::Immutable for $name$(<$($tyvar),*>)?
        where
            $(
                $($tuple_field_ty: $crate::zerocopy::Immutable,)*
            )?

            $(
                $($field_ty: $crate::zerocopy::Immutable,)*
            )?
        {
            fn only_derive_is_allowed_to_implement_this_trait() {}
        }
    ...
    (
        ...
        // SAFETY: See inline.
        unsafe impl $crate::zerocopy::TryFromBytes for $name
        where
            $(
                $field_ty: $crate::zerocopy::FromBytes,
            )*
        ...
        unsafe impl $crate::zerocopy::FromZeros for $name
        where
            $(
                $field_ty: $crate::zerocopy::FromBytes,
            )*
        ...
        unsafe impl $crate::zerocopy::FromBytes for $name
        where
            $(
                $field_ty: $crate::zerocopy::FromBytes,
            )*
        ...
        // any field.
        unsafe impl $crate::zerocopy::IntoBytes for $name
        where
            $(
                $field_ty: $crate::zerocopy::IntoBytes,
            )*
        ...
        unsafe impl $crate::zerocopy::Immutable for $name
        where
            $(
                $field_ty: $crate::zerocopy::Immutable,
            )*
