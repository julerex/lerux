...
use crate::zerocopy::util::polyfills::NumExt as _;
use crate::zerocopy::{
...
mod _def {
    use super::*;
    /// The inner pointer stored inside a [`Ptr`][crate::zerocopy::Ptr].
    ///
    ...
    T: ?Sized + KnownLayout<PointerMetadata = usize>,
{
    ...
    pub(crate) unsafe fn split_at_unchecked(
        self,
        l_len: crate::zerocopy::util::MetadataOf<T>,
    ...
    where
        T: SplitAt,
    {
        let offset = crate::zerocopy::trailing_slice_layout::<T>().offset;
