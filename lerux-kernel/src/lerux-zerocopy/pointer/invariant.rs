...
pub trait Alignment: Sealed {
    #[doc(hidden)]
    #[must_use]
    fn read<T, I, R>(ptr: crate::zerocopy::Ptr<'_, T, I>) -> T
    where
...
/// [`Ptr`](crate::zerocopy::Ptr) referents that permit unsynchronized read operations.
///
...
/// - `A` is [`Exclusive`]
/// - `T` implements [`Immutable`](crate::zerocopy::Immutable)
///
...
impl<A: Aliasing, T: ?Sized + crate::zerocopy::Immutable> Read<A, BecauseImmutable> for T {}
impl<T: ?Sized> Read<Exclusive, BecauseExclusive> for T {}

/// Unsynchronized reads are permitted because only one live [`Ptr`](crate::zerocopy::Ptr)
/// or reference may exist to the referent bytes at a time.
#[derive(Copy, Clone, Debug)]
#[doc(hidden)]
pub enum BecauseExclusive {}

/// Unsynchronized reads are permitted because no live [`Ptr`](crate::zerocopy::Ptr)s or
