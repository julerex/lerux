...
///
/// [`TryFromBytes::is_bit_valid`]: crate::zerocopy::TryFromBytes::is_bit_valid
...
where
    T: crate::zerocopy::Immutable + crate::zerocopy::KnownLayout,
...
pub mod cast {
    ...
    pub unsafe trait Project<Src: ?Sized, Dst: ?Sized> {
        ...
        /// [`Ptr::project`].
        ///
        /// [`Ptr::project`]: crate::zerocopy::pointer::Ptr::project
        ///
        /// # Safety
        ///
    ...
    unsafe impl<T: ?Sized, F, const FIELD_ID: i128> Cast<T, T::Type>
        for Projection<F, { crate::zerocopy::REPR_C_UNION_VARIANT_ID }, FIELD_ID>
    where
        T: HasField<F, { crate::zerocopy::REPR_C_UNION_VARIANT_ID }, FIELD_ID>,
    {
    }
