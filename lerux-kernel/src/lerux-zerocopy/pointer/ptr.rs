...
mod _conversions {
    use super::*;
    use crate::zerocopy::pointer::cast::{CastExact, CastSized, IdCast};
        ...
        I::Aliasing: Reference,
    {
        ...
        pub(crate) fn as_ref(self) -> &'a T {
            ...
            #[cfg(miri)]
            unsafe {
                crate::zerocopy::util::miri_promise_symbolic_alignment(
                    raw.as_ptr().cast(),
        ...
        I: Invariants,
    {
        ...
        where
            V: Validity,
            P: crate::zerocopy::pointer::cast::Project<T, U>,
        {
        ...
        I: Invariants,
    {
        ...
        pub(crate) fn into_unalign(
            self,
        ) -> Ptr<'a, crate::zerocopy::Unalign<T>, (I::Aliasing, Aligned, I::Validity)> {
...
mod _transitions {
        ...
        I: Invariants,
    {
        ...
        {
            if let Err(err) =
                crate::zerocopy::util::validate_aligned_to::<_, T>(self.as_inner().as_non_null())
            {
...
mod _casts {
        ...
        I: Invariants,
    {
        ...
        where
            ...
            I::Aliasing: Reference,
        {
            use crate::zerocopy::pointer::cast::Projection;
...
mod tests {
    ...
    use crate::zerocopy::{pointer::BecauseImmutable, util::testutil::AU64, FromBytes, Immutable};
