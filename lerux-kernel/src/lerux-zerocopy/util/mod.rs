...
where
    T: ?Sized + crate::zerocopy::KnownLayout,
{
...
mod len_of {
        ...
        T: KnownLayout,
    {
        ...
        where
            T: KnownLayout<PointerMetadata = usize>,
        {
            let trailing_slice_layout = crate::zerocopy::trailing_slice_layout::<T>();
            ...
            let layout = match meta {
                ...
                Some(meta) => {
                    ...
                    DstLayout {
                        ...
                        size_info: crate::zerocopy::SizeInfo::Sized { size },
