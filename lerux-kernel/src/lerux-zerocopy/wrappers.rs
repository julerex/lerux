...
use super::*;
use crate::zerocopy::pointer::{invariant::Valid, SizeEq, TransmuteFrom};
...
impl<T> Unalign<T> {
    ...
    pub const fn into_inner(self) -> T {
        ...
        unsafe { crate::zerocopy::util::transmute_unchecked(self) }
    }
...
impl<T: ?Sized + KnownLayout> MaybeUninit<T> {
        ...
        Self: Sized,
    {
        ...
        unsafe { crate::zerocopy::util::transmute_unchecked(val) }
    }
        ...
        Self: Sized,
    {
        ...
        //   and ABI as `T`
        unsafe { crate::zerocopy::util::transmute_unchecked(uninit) }
    }
    ...
    pub fn new_boxed_uninit(meta: T::PointerMetadata) -> Result<Box<Self>, AllocError> {
        ...
        unsafe { crate::zerocopy::util::new_box(meta, alloc::alloc::alloc) }
    }
...
mod read_only_def {
    ...
    ///
    /// [`Immutable`]: crate::zerocopy::Immutable
    #[repr(transparent)]
...
const _: () = {
    use crate::zerocopy::pointer::cast::CastExact;
...
unsafe impl<T: HasTag + ?Sized> HasTag for ReadOnly<T> {
    ...
    type ProjectToTag = crate::zerocopy::pointer::cast::TransitiveProject<
        T,
    ...
    T: HasField<Field, VARIANT_ID, FIELD_ID> + ?Sized,
{
    ...
    fn project(slf: PtrInner<'_, Self>) -> *mut ReadOnly<T::Type> {
        slf.project::<_, <T as SizeEq<ReadOnly<T>>>::CastFrom>()
            .project::<_, crate::zerocopy::pointer::cast::Projection<Field, VARIANT_ID, FIELD_ID>>()
