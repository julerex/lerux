...
pub type PageMapper = crate::rmm::PageMapper<RmmA, crate::memory::TheFrameAllocator>;

/// Available physical memory areas
pub(crate) static AREAS: SyncUnsafeCell<[crate::rmm::MemoryArea; 512]> = SyncUnsafeCell::new(
    [crate::rmm::MemoryArea {
...
// TODO: Share code
pub(crate) fn areas() -> &'static [crate::rmm::MemoryArea] {
