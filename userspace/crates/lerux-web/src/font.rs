//! 5×7 glyphs in an 8×8 cell. Bit 7 is the leftmost pixel.

/// Glyph rows for ASCII 0x20..=0x7E (95 entries × 8 bytes).
pub(crate) const FONT8: [[u8; 8]; 95] = [
    ...
    [0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x20, 0x00], // ;
    ...
    [0x08, 0x10, 0x38, 0x10, 0x10, 0x10, 0x10, 0x00], // f
...
pub(crate) fn glyph(c: u8) -> [u8; 8] {
    if (0x20..=0x7E).contains(&c) {
        FONT8[(c - 0x20) as usize]
    } else {
        FONT8[0]
    }
}
